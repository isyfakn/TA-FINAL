...
Route::group(['middleware' => ['auth']], function () {
    ...
    // Daftar Kegiatan Routes (Manual Routes instead of Resource)
    Route::get('/daftar-kegiatan/{kegiatan}', [DaftarKegiatanController::class, 'index'])->name('daftar-kegiatan.index');
    Route::get('/kegiatan/{kegiatan}/peserta/create', [DaftarKegiatanController::class, 'create'])->name('daftar-kegiatan.create');
    Route::post('/daftar-kegiatan', [DaftarKegiatanController::class, 'store'])->name('daftar-kegiatan.store');
    //Route::delete('/daftar-kegiatan/{daftarKegiatan}', [DaftarKegiatanController::class, 'destroy'])->name('daftar-kegiatan.destroy');
